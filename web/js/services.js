angular.module('ionicApp.services', [])
  .factory('sharedProperties', function ($http, $q, $timeout, $httpParamSerializerJQLike) {
     var LATITUDE;
     var LONGITUDE;
     var ACCURACY = "1000";
     var USER_ID;
     ...
     var position = {latitude: "43.07493", longitude: "-89.381388"}; // coordinates of nicosia
                ...
                .error(function () {
                   if (requests === "max-requests") {
                      if (counter < MAX_REQUESTS) {
                         ...
                         alert("function:getRayzAnswers: Error!");
     ...
     return {
                ...
                .error(function () {
                   if (requests === "max-requests") {
                      if (counter < MAX_REQUESTS) {
                         ...
                         alert("function:getLivefeed: Error!");
        ...
        createRayz: function (message, distance) {
           var deferred = $q.defer();
           var counter = 0;
           var max_distance;
           if (distance === "unlimited") {
              ...
              max_distance = "50";
           } else if (distance === "500 km") {
              max_distance = "500";
           } else { // distance === "5000 km"
              max_distance = "5000";
           }

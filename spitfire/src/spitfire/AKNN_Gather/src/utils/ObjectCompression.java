...
public class ObjectCompression<T extends Serializable> {
	...
	public  byte[]  compress(T myobj) throws IOException{
	...
	public T decompress(byte[] bytes) throws ClassNotFoundException, IOException{
		ByteArrayInputStream bais = new ByteArrayInputStream(bytes);
		GZIPInputStream gzipIn = new GZIPInputStream(bais);
		ObjectInputStream objectIn = new ObjectInputStream(gzipIn);
		T myObj = (T) objectIn.readObject();
		objectIn.close();
		return myObj;
	}
